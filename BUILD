...
The webapp directory implements the regex.cs.arizona.edu website.
It is built separately by "make serve" (to run locally) or
"make deploy" (to upload).  Either of these additionally requires
the Google App Engine in the search path.
