...
func TestBits(t *testing.T) {
	...
	ck(t, "h00", -1, bs.HighBit())
	ck(t, "s00", "{ }", bs)
	ck(t, "s0", "{ 0 }", bs.Set(0))
	ck(t, "s2", "{ 0 2 }", bs.Set(2))
	ck(t, "c0", "{ 2 }", bs.Clear(0))
	ck(t, "l2", 2, bs.LowBit())
	ck(t, "h2", 2, bs.HighBit())
	...
	ck(t, "bs25b", "{ 2 5 }", bs25)
	ck(t, "bs58b", "{ 5 8 }", bs58)
	ck(t, "l58", 5, bs58.LowBit())
	ck(t, "h58", 8, bs58.HighBit())
	ck(t, "orw", "{ 2 5 8 }", bs25.OrWith(bs58))
	ck(t, "andw", "{ 5 8 }", bs58.AndWith(bs25))
	ck(t, "andn", "{ 2 }", bs25.AndNot(bs58))
